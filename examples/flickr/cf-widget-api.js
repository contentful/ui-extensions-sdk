...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * the parent page.
	 */
	var createParentMessageHandler = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parentMessageDispatcher = __webpack_require__(2);
	
	var requestPromises = __webpack_require__(3).create();
	var createApi = __webpack_require__(4);
	  ...
	  return function onMessageReceived(ev) {
	    ...
	    switch (message) {
	      case 'initialize':
	        ...
	        messageDispatcher = parentMessageDispatcher.create(_window, iframeId, ev.origin);
	        api = createApi(data);
	        var event = new CustomEvent('cfWidgetReady', {
	          detail: api
	        });
	      ...
	      case 'confirmedDialog':
	        requestPromises.pop(data.requestId).resolve(data.actionData);
	        break;
	
	      case 'closedDialog':
	        requestPromises.pop(data.requestId).reject(data.actionData);
	        break;
	...
	function ensureOrigin(origin) {
	  if (origin !== 'http://app.joistio.com:8888' && origin !== 'https://app.quirely.com') {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  create: function create(window, iframeId, origin) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fieldsCollection = __webpack_require__(10);
	var parentMessageDispatcher = __webpack_require__(2);
	var requestPromises = __webpack_require__(3).get();
	var messageDispatcher;
	...
	*/
	...
	function createSpaceApi() {
	  var spaceApi = {};['getEntry', 'getAsset', 'getContentType', 'getEntries', 'getAssets', 'getContentTypes', 'createEntry', 'createAsset', 'createContentType'].forEach(function (method) {
	...
	function createWindowApi() {
	  return {
	    ...
	    setupAutoResizer: function setupAutoResizer() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  create: function create(params) {
	    messageDispatcher = parentMessageDispatcher.get();
	    return new FieldsCollection(params.fields, params.locales);
	  },
	  createCurrentField: function createCurrentField(params) {
	    return new CurrentField(params.field.apiName, params.field.data, params.locales, params.fieldLocale);
	  }
	};
